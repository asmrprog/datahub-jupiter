...
export type DatasetEditableProperties = {
    ...
    description?: Maybe<Scalars['String']>;
    dataPlatformIngestionStatus?: Maybe<Scalars['String']>;
};
...
export type GetSchemaBlameInput = {
    ...
    categories?: Maybe<Array<ChangeCategoryType>>;
...
export type Query = {
    ...
    entityExisst?: Maybe<Scalars['Boolean']>;
    /**
 ...
 * Coming soon listEntity queries for listing all entities of a given type
 */
export type QueryEntityExisstArgs = {
    urn: Scalars['String'];
};
